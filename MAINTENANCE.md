...
| Next milestone auto-created + merged PRs auto-assigned after the RC1 version bump (`rc` step 4) | `grep -n "createMilestone" packages/project-management-automation/lib/tasks/add-milestone/index.js` | creates `Gutenberg X.Y+1`, due = previous milestone + 14 days |
